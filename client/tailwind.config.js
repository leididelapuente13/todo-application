	...
	theme: {
		extend: {
			colors: {
				...
				'dark-basic-grayishBlue': 'hsl(234, 11%, 52%)',
			...
			backgroundImage: {
				...
				'mobile-lightTheme-img':
					'url("./src/assets/images/mobile/bg-mobile-light.jpg")',
				'mobile-darkTheme-img':
					'url("./src/assets/images/mobile/bg-mobile-dark.jpg")',
				'desktop-lightTheme-img':
					'url("./src/assets/images/desktop/bg-desktop-dark.jpg")',
				'desktop-darkTheme-img':
					'url("./src/assets/images/desktop/bg-desktop-dark.jpg")'
			}
		}
	},
